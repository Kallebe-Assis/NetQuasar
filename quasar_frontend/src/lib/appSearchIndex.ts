...
export const APP_SEARCH_INDEX: AppScreenEntry[] = [
  ...
  { label: "Localidades", href: `${APP_ROUTES.pops}?tab=localidades`, keywords: ["localidade", "site"] },
  { label: "POPs", href: `${APP_ROUTES.pops}?tab=pops`, keywords: ["pop"] },
  ...
  { label: "OLT — Equipamentos", href: `${APP_ROUTES.olt}?tab=equipamentos` },
  { label: "OLT — ONU's", href: `${APP_ROUTES.olt}?tab=pesquisa`, keywords: ["onu", "onus"] },
  { label: "OLT — Não autorizadas", href: `${APP_ROUTES.olt}?tab=nao_autorizadas` },
  { label: "OLT — Relatórios", href: `${APP_ROUTES.olt}?tab=relatorios` },
  { label: "Equipamentos — BNG", href: APP_ROUTES.bng },
  { label: "BNG — Visão geral", href: `${APP_ROUTES.bng}?tab=overview` },
  { label: "BNG — Relatório", href: `${APP_ROUTES.bng}?tab=relatorio` },
  { label: "BNG — CGNAT e Pools", href: `${APP_ROUTES.bng}?tab=cgnat_pools`, keywords: ["cgnat", "pools"] },
  { label: "BNG — VLANs", href: `${APP_ROUTES.bng}?tab=vlans` },
  { label: "BNG — Interfaces", href: `${APP_ROUTES.bng}?tab=interfaces` },
  { label: "BNG — Autenticações", href: `${APP_ROUTES.bng}?tab=auth` },
  { label: "BNG — Sessões PPPoE", href: `${APP_ROUTES.bng}?tab=sessions`, keywords: ["pppoe"] },
  { label: "Equipamentos — BGP", href: APP_ROUTES.bgp },
  { label: "BGP — Visão Geral", href: `${APP_ROUTES.bgp}?tab=overview` },
  { label: "BGP — Peers", href: `${APP_ROUTES.bgp}?tab=peers` },
  { label: "BGP — Interfaces & LAG", href: `${APP_ROUTES.bgp}?tab=interfaces` },
  { label: "BGP — Óptica", href: `${APP_ROUTES.bgp}?tab=optics` },
  { label: "BGP — CPU & Memória", href: `${APP_ROUTES.bgp}?tab=cpu` },
  { label: "BGP — Saúde do Chassi", href: `${APP_ROUTES.bgp}?tab=chassis` },
  { label: "BGP — QoS", href: `${APP_ROUTES.bgp}?tab=qos` },
  { label: "BGP — RADIUS", href: `${APP_ROUTES.bgp}?tab=radius` },
  { label: "BGP — LLDP", href: `${APP_ROUTES.bgp}?tab=lldp` },
  ...
  { label: "Ferramentas — HTTP/HTTPS", href: `${APP_ROUTES.tools}?tab=http_matrix` },
  { label: "Ferramentas — Domínios", href: `${APP_ROUTES.tools}?tab=host_ping`, keywords: ["ping"] },
  { label: "Ferramentas — ICMP", href: `${APP_ROUTES.tools}?tab=icmp` },
  { label: "Ferramentas — Tracert", href: `${APP_ROUTES.tools}?tab=tracert`, keywords: ["traceroute"] },
  { label: "Ferramentas — Nmap", href: `${APP_ROUTES.tools}?tab=nmap` },
  { label: "Ferramentas — Sniffer", href: `${APP_ROUTES.tools}?tab=sniffer` },
  { label: "Ferramentas — SNMP get", href: `${APP_ROUTES.tools}?tab=snmp` },
  { label: "Ferramentas — SNMP bulk", href: `${APP_ROUTES.tools}?tab=snmp_bulk` },
  { label: "Ferramentas — Telnet", href: `${APP_ROUTES.tools}?tab=telnet` },
  { label: "Ferramentas — SSH", href: `${APP_ROUTES.tools}?tab=ssh` },
  { label: "Ferramentas — SNMP walk", href: `${APP_ROUTES.tools}?tab=snmp_walk` },
  { label: "Ferramentas — Mikrotik", href: `${APP_ROUTES.tools}?tab=mikrotik` },
