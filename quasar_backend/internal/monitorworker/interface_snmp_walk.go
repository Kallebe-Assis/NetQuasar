...
func collectWorkerInterfaceSNMPWalks(ctx context.Context, host, community string, total time.Duration, isMikrotik bool) []probing.SNMPVar {
	...
	walkX, _, _ := probing.SNMPWalk(ctx, probing.SNMPWalkParams{
