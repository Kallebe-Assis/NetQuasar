...
var MetricCatalog = []CatalogEntry{
	...
	// Health
	{Key: "cpu_load", Section: "health", Label: "CPU (%)", Description: "Carga CPU MikroTik (mtxrHlCpuLoad em dispositivos reais).", Placeholder: "1.3.6.1.4.1.14988.1.1.3.10.0", CollectModes: []string{ModeSNMPGet}, DefaultMode: ModeSNMPGet, WalkTarget: TargetTelemetry, Unit: "%"},
	{Key: "cpu_hr", Section: "health", Label: "CPU HOST-RESOURCES", Description: "hrProcessorLoad (alternativa universal).", Placeholder: "1.3.6.1.2.1.25.3.3.1.2.1", CollectModes: []string{ModeSNMPGet}, DefaultMode: ModeSNMPGet, WalkTarget: TargetTelemetry, Unit: "%"},
	...
	{Key: "temperature", Section: "health", Label: "Temperatura", Description: "Sensor principal (dispositivos MikroTik usam frequentemente …3.14.0).", Placeholder: "1.3.6.1.4.1.14988.1.1.3.14.0", CollectModes: []string{ModeSNMPGet}, DefaultMode: ModeSNMPGet, WalkTarget: TargetTelemetry, Unit: "°C", ShowDivisor: true},
	{Key: "board_temperature", Section: "health", Label: "Temp. placa", Description: "Temperatura da placa.", Placeholder: "1.3.6.1.4.1.14988.1.1.3.7.0", CollectModes: []string{ModeSNMPGet}, DefaultMode: ModeSNMPGet, WalkTarget: TargetTelemetry, Unit: "°C", ShowDivisor: true},
	{Key: "cpu_temperature", Section: "health", Label: "Temp. CPU", Description: "Temperatura junto ao CPU.", Placeholder: "1.3.6.1.4.1.14988.1.1.3.6.0", CollectModes: []string{ModeSNMPGet}, DefaultMode: ModeSNMPGet, WalkTarget: TargetTelemetry, Unit: "°C", ShowDivisor: true},
