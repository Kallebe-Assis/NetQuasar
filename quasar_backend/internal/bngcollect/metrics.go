...
var MetricCatalog = []CatalogEntry{
	...
	{Key: "total_online", Section: "subscribers", Label: "Total online", Description: "hwTotalOnlineNum — todos os usuários online.", Placeholder: "1.3.6.1.4.1.2011.5.2.1.14.1.1.0", CollectModes: []string{ModeSNMPGet}, DefaultMode: ModeSNMPGet, Recommended: true},
	...
	{Key: "access_login", Section: "pppoe", Label: "Login (hwAccessUserName)", Description: "Walk coluna de usuários — hwAccessTable.", Placeholder: "1.3.6.1.4.1.2011.5.2.1.15.1.3", CollectModes: []string{ModeSNMPWalk, ModeAccessSessions}, DefaultMode: ModeSNMPWalk},
	...
	{Key: "access_vlan", Section: "pppoe", Label: "VLAN (hwAccessVLANID)", Description: "VLAN de acesso do usuário (QinQ/PPPoE).", Placeholder: "1.3.6.1.4.1.2011.5.2.1.15.1.11", CollectModes: []string{ModeSNMPWalk, ModeAccessSessions}, DefaultMode: ModeSNMPWalk},
