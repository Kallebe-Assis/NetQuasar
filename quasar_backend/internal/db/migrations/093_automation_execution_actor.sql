...
-- +goose Down
DROP INDEX IF EXISTS automation_execution_log_user_started_idx;
DROP INDEX IF EXISTS automation_execution_log_trigger_started_idx;
ALTER TABLE automation_execution_log DROP COLUMN IF EXISTS triggered_by_user_id;
